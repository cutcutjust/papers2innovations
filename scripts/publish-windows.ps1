...
$Manifest = [ordered]@{
  version = $Version
  notes = "Adds a persistent hierarchical collection tree with drag-to-group papers, a fullscreen distraction-free three-column reading mode, and a clearer product workflow for Chinese readers moving from English literature to evidence-grounded research ideas. Existing libraries, settings, and encrypted credentials remain preserved during upgrade."
