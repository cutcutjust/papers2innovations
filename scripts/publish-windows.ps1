...
$Manifest = [ordered]@{
  version = $Version
  notes = "Redesigns model management with editable endpoints, encrypted credential recovery, connection states and clearer workflow assignment, and adds persistent Small, Medium and Large typography across the entire application."
