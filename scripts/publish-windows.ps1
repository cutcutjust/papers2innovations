...
$Manifest = [ordered]@{
  version = $Version
  notes = "Fixes AI-generated LaTeX rendering, adds a shared resizable section outline with PDF page navigation, improves interface contrast, and preserves local settings and encrypted credentials during upgrade."
