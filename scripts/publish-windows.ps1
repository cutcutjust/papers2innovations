...
$Manifest = [ordered]@{
  version = $Version
  notes = "Redesigns Reader as a continuous chapter layout, compacts fragmented OCR labels, removes internal paragraph numbering and redundant top-bar controls, and unifies the application icon."
