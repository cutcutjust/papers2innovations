...
$Manifest = [ordered]@{
  version = $Version
  notes = "Preserves custom settings and encrypted credentials across upgrades, adds manual update checks, simplifies model endpoints to OpenAI- or Anthropic-compatible formats with custom Base URLs, adds 128K/256K/1M/custom context limits, and makes the interface and default AI prompts Chinese-first."
