...
$Manifest = [ordered]@{
  version = $Version
  notes = "Adds automatic in-app update prompts, resizable and collapsible navigation and Reader panels, paper-aware word lookup with pronunciation and contextual meanings, reusable AI answers in the paper context, a refined agent center, deeper drag-and-drop collection management, and a guided local PDF import flow. Existing libraries, settings, and encrypted credentials remain preserved during upgrade."
