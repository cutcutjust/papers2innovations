...
$Manifest = [ordered]@{
  version = $Version
  notes = "Repairs PDF control-character text, extracts vector and raster figures into Markdown, preserves figures through OCR fallback, and renders local paper images inline in Reader."
