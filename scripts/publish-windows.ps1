...
$Manifest = [ordered]@{
  version = $Version
  notes = "Adds a fully inspectable token budget with complete prompt, tool schema, and paper text details; renames output reserve in Chinese; and separates model processing from security and application settings. Existing local settings and encrypted credentials remain preserved during upgrade."
