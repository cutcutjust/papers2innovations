...
$Manifest = [ordered]@{
  version = $Version
  notes = "Rebuilds Immersive Reading around an immutable Markdown source and range-level bilingual overlays. Translated sentences now replace English in place without modifying the paper, while phrases and technical terms remain available from compact anchored details. Translation and paper-dialogue marks use independent clickable lanes. Inline AI explanation cards are replaced by collapsible desktop popovers and mobile sheets with edit, regenerate, delete, follow-up, and context controls. Migration 0014 preserves existing translations, analyses, conversations, settings, encrypted credentials, papers, and prompts during upgrade."
