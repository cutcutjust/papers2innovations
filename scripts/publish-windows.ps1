...
$Manifest = [ordered]@{
  version = $Version
  notes = "Unifies full-page OCR and Markdown cleanup with the shared custom-model registry, supports dotted model IDs and custom Bailian endpoints, renders failed settings actions in red, and refreshes Windows shortcut icons during installation."
