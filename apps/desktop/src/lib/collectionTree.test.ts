...
const paper = (id: string, collectionIds: string[]): LibraryPaper => ({ id, title: id, sourcePath: `${id}.pdf`, status: "READY", progress: 1, pageCount: 1, figures: [], updatedAt: "", collectionIds });
